    ...
    render() {
        ...
        return(
          <div className={classes.body}>                
            ...
            <Link to={this.props.user_id} className={classes.root}><Avatar alt="profile_image" src={this.props.profile_image} /><p className={classes.id}>{this.props.user_id}</p></Link>
            </div>
            <hr/>
